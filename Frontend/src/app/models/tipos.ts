...
export type EstadoCita = 'PENDIENTE' | 'CONFIRMADA' | 'REPROGRAMADA' | 'CANCELADA' | 'SOLICITUD_REPROGRAMACION' | 'SOLICITUD_CANCELACION' | 'REPROGRAMACION_ACEPTADA' | 'REPROGRAMACION_RECHAZADA';
